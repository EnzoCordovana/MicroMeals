...
public class Food {
     ...
     */
    public Food(String nom, String description, double prix) {
        this.nom = nom;
     ...
     * @param nom une chaine de caracteres avec le nom a utiliser
     */
     ...
     * @param description une chaine de caracteres avec la description a utiliser
     */
